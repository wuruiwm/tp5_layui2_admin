<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/wwwroot/test.htto.cn/public/../app/admin/view/main/index.html";i:1569741706;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="layui-col-md4">
      ...
      <div class="layui-card">
        ...
        <div class="layui-card-body layui-text layadmin-text">
          <p>测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容测试内容</p>
        </div>
      </div>
