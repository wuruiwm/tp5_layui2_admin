<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/test.htto.cn/public/../app/admin/view/index/index.html";i:1567845868;s:59:"/www/wwwroot/test.htto.cn/app/admin/view/public/header.html";i:1568786828;s:57:"/www/wwwroot/test.htto.cn/app/admin/view/public/left.html";i:1571621369;s:59:"/www/wwwroot/test.htto.cn/app/admin/view/public/footer.html";i:1567845868;}*/ ?>
<!-- 头部公共文件 -->
<!DOCTYPE html>
<html>
<head>
...
<body class="kit-theme">
    <div class="layui-layout layui-layout-admin kit-layout-admin">
        <div class="layui-header">
            <div class="layui-logo" id="logo"><span>后台管理框架</span></div>
 ...
 * @LastEditors: 傍晚升起的太阳
 * @LastEditTime: 2019-10-21 09:29:27
 -->
            ...
            <div class="layui-side-scroll">
                ...
                <?php if(is_array($menus) || $menus instanceof \think\Collection || $menus instanceof \think\Paginator): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                    <li class="layui-nav-item <?php if($data['is_open'] == 1): ?>layui-nav-itemed<?php endif; ?>">
                        <a href="javascript:;">
                            <label style="display: inline-block; min-width: 20px;text-align: left;" for="icon"><i class="fa <?php echo $data['icon']; ?>" aria-hidden="true"></i></label>
                        ...
                        <?php if(!(empty($data['list']) || (($data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator ) && $data['list']->isEmpty()))): if(is_array($data['list']) || $data['list'] instanceof \think\Collection || $data['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(!(empty($vo['list']) || (($vo['list'] instanceof \think\Collection || $vo['list'] instanceof \think\Paginator ) && $vo['list']->isEmpty()))): ?>
                            <li>
                                <a class="table" href="javascript:;">
                                    <label style="display: inline-block; min-width: 20px;text-align: left;" for="icon"><i class="fa <?php echo $vo['icon']; ?>"></i></label>
                                    <span> <?php echo $vo['name']; ?></span> <span class="angle"><i class="fa fa-angle-down"></i><span></span></a>
                                <ul <?php if($vo['is_open'] == 1): ?>style="display:block;"<?php endif; ?>>
                                    ...
                                    <li><a href="javascript:;" data-url="<?php echo $co['url']; ?>" data-icon="<?php echo $co['icon']; ?>" data-title="<?php echo $co['name']; ?>" kit-target data-id='<?php echo $co['id']; ?>'>
                                            <label style="display: inline-block; min-width: 20px;text-align: left;" for="icon"><i class="fa <?php echo $co['icon']; ?>" aria-hidden="true"></i></label>
                                        <span> <?php echo $co['name']; ?></span></a></li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </li>
                            <?php else: ?>
                            <li>
                                <a href="javascript:;" data-url="<?php echo $vo['url']; ?>" data-icon="<?php echo $vo['icon']; ?>" data-title="<?php echo $vo['name']; ?>" kit-target data-id='<?php echo $vo['id']; ?>'>
                                    <label style="display: inline-block; min-width: 20px;text-align: left;" for="icon"><i class="fa <?php echo $vo['icon']; ?>" aria-hidden="true"></i></label>
